    ...
    <Card className = "md:h-auto w-[80%] sm:w-[420px] p-4 sm:8">
      <CardHeader>
        ...
        <CardDescription className = "text-sm text-center text-accent-foreground">
          Usa un correo o servicio para iniciar sesión
        </CardDescription>
      </CardHeader>
      <CardContent className = "px-2 sm:px-6">
        ...
        <p className = "text-center text-sm mt-2 text-muted-foreground">
          ¿No tienes una cuenta? <Link className = "text-sky-700 ml-4 hover:underline cursor-pointer" href = "sing-up"> Crear cuenta
          </Link>
